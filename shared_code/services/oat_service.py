...
def get_oat_package_list(
    ...
    Swagger: https://adc.github.trendmicro.com/pages/CoreTech-SG/xdr-doc/?urls.primaryName=public-preview#/Observed%20Attack%20Techniques%20Pipeline%20(SIEM%20Integration)/get_v1_0_preview_ath_oat_dataPipelines__id__packages
    Args:
...
def download_oat_file(
    ...
    Swagger: https://adc.github.trendmicro.com/pages/CoreTech-SG/xdr-doc/?urls.primaryName=public-preview#/Observed%20Attack%20Techniques%20Pipeline%20(SIEM%20Integration)/get_v1_0_preview_ath_oat_dataPipelines__id__packages__packageId_
    Args:
        token (str): account token
...
def get_pipeline_id_for_migration(token: str) -> str:
    ...
    Swagger: https://adc.github.trendmicro.com/pages/CoreTech-SG/xdr-doc/?urls.primaryName=public-merged-beta#/Observed%20Attack%20Techniques%20Pipeline/get_beta_xdr_oat_dataPipeline
    Returns:
        str: pipelineId
    """
...
def is_registered_by_pipeline_id(token: str, pipeline_id: str) -> bool:
    ...
    Swagger: https://adc.github.trendmicro.com/pages/CoreTech-SG/xdr-doc/?urls.primaryName=public-preview#/Observed%20Attack%20Techniques%20Pipeline%20(SIEM%20Integration)/get_v1_0_preview_ath_oat_dataPipelines__id_
    Returns:
...
def register_oat_and_get_pipeline_id(
    ...
    Swagger: https://adc.github.trendmicro.com/pages/CoreTech-SG/xdr-doc/?urls.primaryName=public-preview#/Observed%20Attack%20Techniques%20Pipeline%20(SIEM%20Integration)/post_v1_0_preview_ath_oat_dataPipelines
    Args:
        token (str): account token
